                ...
                <table className="table table-hover thanh-son-table">
                  <thead>
                    <tr className="th-list">
                      ...
                      <th className="px-3 py-2 bg-primary ">
                        Căn cước công dân
                      </th>
                  ...
                  <tbody>
                    ...
                    {employees.map((employee, index) => (
                      <tr
                        className={`tr-employee ${
                          deleteEmployee && deleteEmployee.id === employee.id
                      ...
                      >
                        ...
                        <td
                          className="  py-2 code-employee "
                          onMouseEnter={() =>
                            handleMouseEnter(employee.nameEmployee)
                          }
                        ...
                        >
                          ...
                          />
                          {employee.nameEmployee.length > quantity
                            ? `${employee.nameEmployee.slice(0, quantity)}...`
            ...
            <button
              ...
              onClick={() => {
                Swal.fire({
                  icon: "warning",
                  title:
                    "Vui lòng chọn nhân viên trước khi thực hiện thao tác này.",
                  showConfirmButton: false,
                  timer: 1500,
                }).then();
              }}
