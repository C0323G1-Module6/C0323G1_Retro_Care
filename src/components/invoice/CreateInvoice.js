                    ...
                    <div className="row">
                        <div className="col-12">
                            <fieldset className="border border-dark rounded-3 p-3 shadow-sm" style={{ backgroundColor: '#f8f9fa' }}>
                                ...
                                <button onclick="addRow()" type="button" className="btn btn-outline-primary"><i className="fa-solid fa-plus" /> Thêm thuốc
                                </button>
                            </fieldset>
                            <div className="d-flex justify-content-end gap-3 my-3">
                                <button type="button" className="btn btn-outline-primary"><i className="fa-solid fa-plus" /> Hoàn thành
                                </button>
                                ...
                                <a href="/prototype/warehouse/HuyHD_Warehouse.html">
                                    <button type="button" className="btn btn-outline-primary">
                                        <i className="fa-regular fa-circle-left" /> Trở về
                                    </button>
                                </a>
                            </div>
                        </div>
