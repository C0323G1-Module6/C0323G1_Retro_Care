...
const UserCustomer = () => {
    ...
    return (
        <>
            <div
                className="row shadow mx-auto image-with-body"
                style={{ width: "80%", marginTop: "2%", borderRadius: 20,marginLeft:"2%" }}
            >
                <Formik className="col-5 image-with-text"
                        initialValues={{
                            ...customer,
                        }}
                ...
                >
                    <div style={{ marginTop: "8%" }}>
                        <h5 style={{ fontWeight: "bold",color: "white"}}>Bạn đã cập nhật ?</h5>
                    ...
                    <div className=" mt-5">
                        <h5 style={{ fontWeight: "bold",color: "white" }}>Bạn đã cập nhật trước khi ?</h5>
                        <p style={{ color: "#ffffff", fontWeight: "bold" }}>
                    ...
                    <div className="mt-5">
                        <h5 style={{ fontWeight: "bold",color: "white" }}>Làm sao để cập nhật thông tin ?</h5>
                        <p style={{ color: "#ffffff", fontWeight: "bold" }}>
                ...
                <Formik className="col-7 px-3 pt-3" style={{ borderRadius: 20 }}>
                    ...
                    <div className="mx-auto pt-2 pb-3" style={{ width: "90%" }}>
                        ...
                        <div className="mb-3 row">
                            ...
                            <div className="col-3">
                                <button className=" btn btn-success w-100">Cập nhật </button>
                            </div>
                        </div>
                    </div>
                </Formik>
